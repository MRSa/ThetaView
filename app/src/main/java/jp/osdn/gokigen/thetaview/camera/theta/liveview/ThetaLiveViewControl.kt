package jp.osdn.gokigen.thetaview.camera.theta.liveview
...
import jp.osdn.gokigen.thetaview.utils.communication.SimpleLiveViewSlicer

class ThetaLiveViewControl(private val liveViewListener: CameraLiveViewListenerImpl) : ILiveViewController
{
